...
//        produces = {"application/json"},
//        method = RequestMethod.GET)
////    default Optional<NodeDTO> apiGetNode(@ApiParam(value = "UUID of the node to get", required = true) @PathVariable("nodeId") UUID nodeId) {
//    public Optional<NodeDTO> getNode(@ApiParam(value = "UUID of the node to get", required = true) @PathVariable("nodeId") Long nodeId) {
//            log.debug("REST request to get Node : {}", nodeId);
