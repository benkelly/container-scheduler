...
describe('Service Tests', () => {
  describe('Container Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Container(0, 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should return a list of Container', async () => {
        const returnedFromService = Object.assign(
          {
            containerId: 'BBBBBB',
            name: 'BBBBBB',
